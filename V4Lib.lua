...
local function CreateMacroWindow(opts)
    ...
    frame.Size                   = UDim2.new(0, W, 0, TITLE_H + SCROLL_H + PAD + BTN_H + PAD)
    ...
    -- Open Clicker Button 
    local clickerWindowUI = nil

    local openBtn = Instance.new("TextButton", frame)
    openBtn.Size                   = UDim2.new(1, -12, 0, BTN_H)
    openBtn.Position               = UDim2.new(0, 6, 1, -(BTN_H + PAD))
    openBtn.BackgroundColor3       = T.dropBg
    openBtn.BackgroundTransparency = 0.1
    openBtn.Text                   = "Open Start"
    openBtn.Font                   = T.font
    openBtn.TextSize               = 13
    ...
    openBtn.MouseButton1Click:Connect(function()
        if clickerWindowUI then
            clickerWindowUI.Destroy()
            clickerWindowUI = nil
            openBtn.Text = "Open Start"
            onStop()
            return
        ...
        -- Open V3 Clicker
        clickerWindowUI = CreateMiniClickerV3({
            defaultText = "Start",
            clickedText = "Stop",
            default     = false,
            width       = 120,
